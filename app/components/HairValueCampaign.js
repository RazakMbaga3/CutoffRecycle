  ...
  const valueCards = [
    {
      ...
      impact: 'Diverted 4 tons of human hair waste from landfill and littering, saving the land, water and atmosphere.',
      icon: (
    ...
    },
    {
      ...
      impact: 'Created a sustainable income source for 350+ people through our human hair waste collection initiative.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
      ),
      image: "/new/nywele.webp"
    },
    {
      title: 'Crops',
