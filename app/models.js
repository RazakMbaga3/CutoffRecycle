...
const OtherOrderTypeSchema = new mongoose.Schema({user: { type: mongoose.Schema.Types.ObjectId, ref: "UserType" }, amount:String,name:String, date: String, status: String})
...
const UserTypeSchema = new mongoose.Schema({name: String,email: String,password: String,customerData: CustomerDataTypeSchema, barberData:BarberDataTypeSchema, newBarber:NewBarberTypeSchema}, { strict: false })
