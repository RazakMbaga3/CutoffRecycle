      ...
      <section className="relative h-[70vh] bg-gradient-to-r from-brand-green-ultra-light to-white text-brand-black overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 h-full flex flex-col justify-center items-center relative z-10">          <div className="w-full max-w-4xl mx-auto text-center">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
              <span className="text-brand-black/70 text-sm mb-2 animate-fade-in" style={{animationDelay: '1s'}}>
                Scroll to explore
              </span>
              <div className="relative">
                <div className="absolute -inset-2 bg-brand-green/20 rounded-full blur-md animate-pulse"></div>
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-6 w-6 text-brand-green relative z-10 animate-bounce" 
                  fill="none" 
                  viewBox="0 0 24 24" 
                  stroke="currentColor"
                >
